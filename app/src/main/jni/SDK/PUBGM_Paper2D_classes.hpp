...
{
public:
	unsigned char                                      bLooping : 1;                                             // 0x05B0(0x0001) (Net)
	unsigned char                                      bReversePlayback : 1;                                     // 0x05B0(0x0001) (Net)
	unsigned char                                      bPlaying : 1;                                             // 0x05B0(0x0001) (Net)
	unsigned char                                      UnknownData00[0x3];                                       // 0x05B1(0x0003) MISSED OFFSET
	float                                              AccumulatedTime;                                          // 0x05B4(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	int                                                CachedFrameIndex;                                         // 0x05B8(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                SpriteColor;                                              // 0x05BC(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	class UBodySetup*                                  CachedBodySetup;                                          // 0x05CC(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnFinishedPlaying;                                        // 0x05D0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	TArray<struct FSpriteInstanceData>                 PerInstanceSpriteData;                                    // 0x05B0(0x000C) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData00[0x14];                                      // 0x05BC(0x0014) MISSED OFFSET
...
{
public:
	int                                                RandomSeed;                                               // 0x0590(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SegmentOverlapAmount;                                     // 0x0594(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                TerrainColor;                                             // 0x0598(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	int                                                ReparamStepsPerSegment;                                   // 0x05A8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ESpriteCollisionMode>             SpriteCollisionDomain;                                    // 0x05AC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	class UBodySetup*                                  CachedBodySetup;                                          // 0x05B4(0x0004) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData01[0x18];                                      // 0x05B8(0x0018) MISSED OFFSET
...
{
public:
	int                                                TileHeight;                                               // 0x05B0(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UPaperTileSet*                               DefaultLayerTileSet;                                      // 0x05B4(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UMaterialInterface*                          Material;                                                 // 0x05B8(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	TArray<class UPaperTileLayer*>                     TileLayers;                                               // 0x05BC(0x000C) (ZeroConstructor, Deprecated)
	struct FLinearColor                                TileMapColor;                                             // 0x05C8(0x0010) (Edit, IsPlainOldData)
	int                                                UseSingleLayerIndex;                                      // 0x05D8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseSingleLayer;                                          // 0x05DC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x05DD(0x0003) MISSED OFFSET
	class UPaperTileMap*                               TileMap;                                                  // 0x05E0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
