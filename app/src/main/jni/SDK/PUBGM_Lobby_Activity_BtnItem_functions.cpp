...
// Function Lobby_Activity_BtnItem.Lobby_Activity_BtnItem_C.SetFxStatus
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                           bNew                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ULobby_Activity_BtnItem_C::SetFxStatus(bool bNew)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc = UObject::FindObject<UFunction>("Function Lobby_Activity_BtnItem.Lobby_Activity_BtnItem_C.SetFxStatus");

	ULobby_Activity_BtnItem_C_SetFxStatus_Params params;
	params.bNew = bNew;
