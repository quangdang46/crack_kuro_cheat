...
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x0B20(0x0004) (Transient, DuplicateTransient)
	class UBackpackAvatarItemColor*                    BasedAvatarColorHandle;                                   // 0x0B24(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UBackpackAvatarItemPattern*                  BasedAvatarPatternHandle;                                 // 0x0B28(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<int>                                        HoodClothSubTypeMap;                                      // 0x0B2C(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	EBattleItemUseReason                               PreEquipClothReason;                                      // 0x0B38(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0B39(0x0007) MISSED OFFSET
	unsigned char                                      UnknownData01[0x28];                                      // 0x0B39(0x0028) UNKNOWN PROPERTY: SoftObjectProperty CharacterAvatarComp2_BP.CharacterAvatarComp2_BP_C.MaleBatchBodySoftPath
	unsigned char                                      UnknownData02[0x28];                                      // 0x0B68(0x0028) UNKNOWN PROPERTY: SoftObjectProperty CharacterAvatarComp2_BP.CharacterAvatarComp2_BP_C.FemaleBatchBodySoftPath
	bool                                               bForbidBindAvatarEquippedEvent;                           // 0x0B90(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0B91(0x0003) MISSED OFFSET
	TArray<int>                                        NeedModifyVehicleID;                                      // 0x0B94(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
