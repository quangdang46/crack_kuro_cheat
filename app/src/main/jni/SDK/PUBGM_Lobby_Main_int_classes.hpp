...
public:
	...
	class ASkyLight*                                   SkyLight_1_EdGraph_10_RefProperty;                        // 0x0358(0x0004) (ZeroConstructor, IsPlainOldData)
	class APointLight*                                 PointLight_0_EdGraph_10_RefProperty;                      // 0x035C(0x0004) (ZeroConstructor, IsPlainOldData)
	class ADirectionalLight*                           DirectionalLight_0_EdGraph_10_RefProperty;                // 0x0360(0x0004) (ZeroConstructor, IsPlainOldData)
	class ACameraActor*                                LobbySecondCam_EdGraph_10_RefProperty;                    // 0x0364(0x0004) (ZeroConstructor, IsPlainOldData)
	class ACameraActor*                                LobbyFirstCam_EdGraph_10_RefProperty;                     // 0x0368(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	void OnShowLobbyGM();
	void OnSimulateTestReConnect();
	void OnAndroidBack();
	void RegistPersistLevelObjs(class UFrontendUtils* Utils);
	void InpActEvt_B_K2Node_InputKeyEvent_8(const struct FKey& Key);
