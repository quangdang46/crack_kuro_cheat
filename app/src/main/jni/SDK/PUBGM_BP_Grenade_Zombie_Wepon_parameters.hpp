...
#include "PUBGM_BP_Grenade_Zombie_Wepon_classes.hpp"
...
struct ABP_Grenade_Zombie_Wepon_C_GetSkillEntryForMeleeWeapon_Params
{
...
struct ABP_Grenade_Zombie_Wepon_C_UserConstructionScript_Params
{
};
