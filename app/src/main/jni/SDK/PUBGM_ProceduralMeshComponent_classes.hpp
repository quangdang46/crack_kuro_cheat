...
{
public:
	TArray<struct FProcMeshSection>                    ProcMeshSections;                                         // 0x05B0(0x000C) (ZeroConstructor)
	TArray<struct FKConvexElem>                        CollisionConvexElems;                                     // 0x05BC(0x000C) (ZeroConstructor)
	struct FBoxSphereBounds                            LocalBounds;                                              // 0x05C8(0x001C) (IsPlainOldData)
	TArray<class UBodySetup*>                          AsyncBodySetupQueue;                                      // 0x05E4(0x000C) (ZeroConstructor, Transient)
