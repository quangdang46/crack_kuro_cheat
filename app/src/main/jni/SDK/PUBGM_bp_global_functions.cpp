...
// Function bp_global.bp_global_C.EventSlapJumpUrl_NoFetch
// (BlueprintCallable, BlueprintEvent)

void Abp_global_C::EventSlapJumpUrl_NoFetch()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc = UObject::FindObject<UFunction>("Function bp_global.bp_global_C.EventSlapJumpUrl_NoFetch");

	Abp_global_C_EventSlapJumpUrl_NoFetch_Params params;
...
// Function bp_global.bp_global_C.EventSlapJumpUrl
// (BlueprintCallable, BlueprintEvent)

void Abp_global_C::EventSlapJumpUrl()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc = UObject::FindObject<UFunction>("Function bp_global.bp_global_C.EventSlapJumpUrl");

	Abp_global_C_EventSlapJumpUrl_Params params;
