...
#include "PUBGM_RankSmall_Integral_Name_UIBP_parameters.hpp"
...
void URankSmall_Integral_Name_UIBP_C::SetRankIntegral(const struct FBP_STRUCT_RankIntegralLevel_type& RankIntegralLevel_Info)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
