...
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x0728(0x0004) (Transient, DuplicateTransient)
	TArray<int>                                        DefaultStyleIDList;                                       // 0x072C(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
