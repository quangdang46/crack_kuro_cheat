...
public:
	...
	class UBugReporter*                                BugReporter;                                              // 0x0214(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData06[0x7];                                       // 0x028D(0x0007) MISSED OFFSET
	class UCDNUpdate*                                  CDNUpdater;                                               // 0x0294(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                ODPaksPoolSize;                                           // 0x0298(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ODPaksPoolSizeLowend;                                     // 0x029C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ODPaksPoolSizeLowendThreshold;                            // 0x02A0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               ODPaksEnable;                                             // 0x02A4(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData07[0x23];                                      // 0x02A5(0x0023) MISSED OFFSET
	struct FName                                       UnrealNetworkStatus;                                      // 0x02C8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x10];                                      // 0x02D0(0x0010) MISSED OFFSET
	float                                              UnrealNetworkConnectingTimer;                             // 0x02E0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x10];                                      // 0x02E4(0x0010) MISSED OFFSET
	float                                              UnrealNetworkConnectingTime;                              // 0x02F4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseDynamicCreateLuaManager;                              // 0x02F8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x02F9(0x0003) MISSED OFFSET
	TArray<struct FString>                             PersistentLuaManager;                                     // 0x02FC(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData11[0x4];                                       // 0x0308(0x0004) MISSED OFFSET
	bool                                               bPatchReInitSequence;                                     // 0x030C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData12[0x3];                                       // 0x030D(0x0003) MISSED OFFSET
	class ULuaStateWrapper*                            LuaStateWrapper;                                          // 0x0310(0x0004) (ZeroConstructor, IsPlainOldData)
	class ULuaEventBridge*                             LuaEventBridgeInstace;                                    // 0x0314(0x0004) (ZeroConstructor, IsPlainOldData)
	class UBattleWindowMgrLuaUtils*                    LuaBattleWindowMgr;                                       // 0x0318(0x0004) (ZeroConstructor, IsPlainOldData)
	class ULuaBlueprintMgr*                            LuaBlueprintSysMgr;                                       // 0x031C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x4];                                       // 0x0320(0x0004) MISSED OFFSET
	struct FString                                     ScriptBPRelativeDir;                                      // 0x0324(0x000C) (ZeroConstructor, Config)
	struct FString                                     ScriptRelativeDir;                                        // 0x0330(0x000C) (ZeroConstructor, Config)
	struct FString                                     InGameLuaDir;                                             // 0x033C(0x000C) (ZeroConstructor, Config)
	struct FString                                     PreloadLuaFileRelativePath;                               // 0x0348(0x000C) (ZeroConstructor, Config)
	TArray<struct FString>                             LuaDirList;                                               // 0x0354(0x000C) (ZeroConstructor, Config)
	TArray<struct FString>                             NoGCPackage;                                              // 0x0360(0x000C) (ZeroConstructor, Config)
	float                                              LuaTickTime;                                              // 0x036C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bCallLuaTick;                                             // 0x0370(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAutoLoginEnable;                                         // 0x0371(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData14[0x26];                                      // 0x0372(0x0026) MISSED OFFSET
	int                                                PingFirstReportIntervalSecond;                            // 0x0398(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                PingReportIntervalSecond;                                 // 0x039C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                LossSyncIntervalSecond;                                   // 0x03A0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                vmInstrumentOptimization;                                 // 0x03A4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UTssManager*                                 TssMgr;                                                   // 0x03A8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData15[0x1C];                                      // 0x03AC(0x001C) MISSED OFFSET
	float                                              PingReportInterval;                                       // 0x03C8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData16[0x9C];                                      // 0x03CC(0x009C) MISSED OFFSET
	uint32_t                                           ImageDownloadClearDayCount;                               // 0x0468(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	struct FScriptMulticastDelegate                    UIStackChangeDelegate;                                    // 0x046C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    UIStackRecoverDelegate;                                   // 0x0478(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData17[0x4];                                       // 0x0484(0x0004) MISSED OFFSET
	struct FScriptDelegate                             GetUserSettingsDelegate;                                  // 0x0488(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             SaveUserSettingsDelegate;                                 // 0x0498(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnFRefreshAdaptationUIEvent;                              // 0x04A8(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFRefreshAdaptationExUIEvent;                            // 0x04B4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FString                                     UserSettingsClassName;                                    // 0x04C0(0x000C) (ZeroConstructor, Config)
	struct FString                                     LanguageSettingsClassName;                                // 0x04CC(0x000C) (ZeroConstructor, Config)
	struct FString                                     ActiveSaveGameName;                                       // 0x04D8(0x000C) (ZeroConstructor, Config)
	struct FString                                     CachedSaveGameName;                                       // 0x04E4(0x000C) (ZeroConstructor, Config)
	struct FString                                     LanguageSaveGameName;                                     // 0x04F0(0x000C) (ZeroConstructor, Config)
	class UClass*                                      UserSettingsClass;                                        // 0x04FC(0x0004) (ZeroConstructor, IsPlainOldData)
	class USaveGame*                                   UserSettings;                                             // 0x0500(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FCustomSettingSaveGame>              CustomSettingSaveGames;                                   // 0x0504(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData18[0x84];                                      // 0x0510(0x0084) MISSED OFFSET
	class UImageDownloader*                            ImageDownloaderInGame;                                    // 0x0594(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FpsForWindowClient;                                       // 0x0598(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UUDPPingCollector*                           UDPPingCollector;                                         // 0x059C(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               UIElemLayoutJsonConfigSwitch;                             // 0x05A0(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationAllSwitch;                                          // 0x05A1(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationBattleSwitch;                                       // 0x05A2(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationRankSwitch;                                         // 0x05A3(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SelfieSwitch;                                             // 0x05A4(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               ReportBugSwitch;                                          // 0x05A5(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               FirstVoicePopupSwitch;                                    // 0x05A6(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRForbidVoiceSwitch;                                    // 0x05A7(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRSettingSwitch;                                        // 0x05A8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData19[0x3];                                       // 0x05A9(0x0003) MISSED OFFSET
	int                                                GDPRUserType;                                             // 0x05AC(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bShouldShowAdaptTipInLobby;                               // 0x05B0(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData20[0x3];                                       // 0x05B1(0x0003) MISSED OFFSET
	float                                              fLaggingFPSDiffThreshold;                                 // 0x05B4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMin;                              // 0x05B8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMax;                              // 0x05BC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThreshold;                               // 0x05C0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMin;                            // 0x05C4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMax;                            // 0x05C8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fFPSReportInterval;                                       // 0x05CC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData21[0xC];                                       // 0x05D0(0x000C) MISSED OFFSET
	bool                                               bUnLoadNoGcPackage;                                       // 0x05DC(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData22[0x3];                                       // 0x05DD(0x0003) MISSED OFFSET
	TArray<class UPackage*>                            NoGcPackages;                                             // 0x05E0(0x000C) (ZeroConstructor)
	bool                                               bFlushAsyncLoadingBeforeGC;                               // 0x05EC(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnablePandora;                                           // 0x05ED(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData23[0x1];                                       // 0x05EE(0x0001) MISSED OFFSET
	bool                                               bEnableJMLog;                                             // 0x05EF(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData24[0x84];                                      // 0x05F0(0x0084) MISSED OFFSET
	bool                                               bEnableH5Cache;                                           // 0x0674(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData25[0x3];                                       // 0x0675(0x0003) MISSED OFFSET
	class UColorBlindnessMgr*                          ColorBlindnessMgrInstace;                                 // 0x0678(0x0004) (ZeroConstructor, IsPlainOldData)
	class UEffectSettingMgr*                           EffectSettingMgrInstace;                                  // 0x067C(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FNativeHUDTickContainer>             NativeHUDTickList;                                        // 0x0680(0x000C) (ZeroConstructor)
	bool                                               IsNativeHUDTickLock;                                      // 0x068C(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               IsShutDown;                                               // 0x068D(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData26[0x2];                                       // 0x068E(0x0002) MISSED OFFSET
	int                                                NativeHUDTickIndex;                                       // 0x0690(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAsyncLoadHelper*                            AsyncLoadHelper;                                          // 0x0694(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     BattleUtilsClassName;                                     // 0x0698(0x000C) (ZeroConstructor, Config)
	class UBattleUtils*                                BattleUtils;                                              // 0x06A4(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData27[0x8];                                       // 0x06A8(0x0008) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x48];                                      // 0x008C(0x0048) MISSED OFFSET
	bool                                               Disable;                                                  // 0x00D4(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4B];                                      // 0x00D5(0x004B) MISSED OFFSET
	...
	unsigned char                                      UnknownData03[0x1];                                       // 0x0123(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x12];                                      // 0x0132(0x0012) MISSED OFFSET
	...
	unsigned char                                      UnknownData05[0x13F];                                     // 0x0151(0x013F) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x63];                                      // 0x0235(0x0063) MISSED OFFSET
	struct FString                                     DownloadDir;                                              // 0x0298(0x000C) (ZeroConstructor, Config)
	struct FString                                     PufferTmpDir;                                             // 0x02A4(0x000C) (ZeroConstructor, Config)
	uint32_t                                           CleanFlagVer;                                             // 0x02B0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	TArray<struct FString>                             CleanFileNamePattern;                                     // 0x02B4(0x000C) (ZeroConstructor, Config)
	bool                                               PreFetchPakEnable;                                        // 0x02C0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               PreFetchFileClearEnable;                                  // 0x02C1(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               PreFetchConvertEnable;                                    // 0x02C2(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x02C3(0x0001) MISSED OFFSET
	TArray<struct FString>                             PreFetchPakNames;                                         // 0x02C4(0x000C) (ZeroConstructor, Config)
	uint32_t                                           PreFetchReserveredDiskSpace;                              // 0x02D0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               PreFetchODPak_Enable;                                     // 0x02D4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x02D5(0x0003) MISSED OFFSET
	int                                                PreFetchODPaks_MaxNum;                                    // 0x02D8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                PreFetchODPaks_BatchSize;                                 // 0x02DC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                PreFetchODPaks_FetchedNum;                                // 0x02E0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                PreFetchODPaks_FetchedIndex;                              // 0x02E4(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FString>                             PreFetchODPaks_Filenames;                                 // 0x02E8(0x000C) (ZeroConstructor, Config)
	bool                                               AllowIOSBGDownload;                                       // 0x02F4(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               AllowIOSBGDownloadPush;                                   // 0x02F5(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               DisableJPKRBGDownloadNightPush;                           // 0x02F6(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0x1];                                       // 0x02F7(0x0001) MISSED OFFSET
	int                                                DisableJPKRBGDownloadNightPushAfterHour;                  // 0x02F8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                DisableJPKRBGDownloadNightPushBeforeHour;                 // 0x02FC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                IOSBGDownloadPushDelaySeconds;                            // 0x0300(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               DisableBGDownloadNotification;                            // 0x0304(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x0305(0x0003) MISSED OFFSET
	float                                              PreFetchODPaks_StartTime;                                 // 0x0308(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     PreFetchODPaks_ConfigName;                                // 0x030C(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData06[0x10];                                      // 0x0318(0x0010) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData02[0x50];                                      // 0x0068(0x0050) MISSED OFFSET
	class UGameFrontendHUD*                            GameFrontendHUD;                                          // 0x00B8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x24];                                      // 0x00BC(0x0024) MISSED OFFSET
...
public:
	...
	TMap<int, struct FDynamicWidgetAsyncLoadData>      PandingAsyncLoadRequests;                                 // 0x019C(0x0050) (ZeroConstructor)
	...
	void OnAsyncLoadWidgetClassObj(class UObject* ClassObj, int RequestID);
	...
	void GetWidgetHandleAsyncWithCallBack(const struct FString& WidgetKey, const struct FScriptDelegate& Callback);
...
public:
	...
	static void ShareWithUploadPhotoByChannel(const struct FString& _imgPath, int _channel, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
