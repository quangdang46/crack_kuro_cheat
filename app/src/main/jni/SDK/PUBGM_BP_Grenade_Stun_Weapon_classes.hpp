...
#include "PUBGM_BP_Grenade_Stun_Weapon_structs.hpp"
...
public:
	...
	static UClass* StaticClass()
	{
		...
		if (!pStaticClass)
			 pStaticClass = UObject::FindClass("BlueprintGeneratedClass BP_Grenade_Stun_Weapon.BP_Grenade_Stun_Weapon_C");
		return pStaticClass;
	}
