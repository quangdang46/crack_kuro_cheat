...
struct FEQSParametrizedQueryExecutionRequest
{
	...
	TEnumAsByte<enum EEnvQueryRunMode>                 RunMode;                                                  // 0x0030(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FEnvTraceData
{
	...
	TEnumAsByte<enum ETraceTypeQuery>                  TraceChannel;                                             // 0x0020(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<enum ECollisionChannel>                SerializedChannel;                                        // 0x0021(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<enum EEnvTraceShape>                   TraceShape;                                               // 0x0022(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<enum EEnvQueryTrace>                   TraceMode;                                                // 0x0023(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
struct FEnvDirection
{
	...
	TEnumAsByte<enum EEnvDirection>                    DirMode;                                                  // 0x000C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
};
