...
struct FAnimNode_BlendBoneByChannel : public FAnimNode_Base
{
	...
	TEnumAsByte<enum EBoneControlSpace>                TransformsSpace;                                          // 0x005C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_BoneDrivenController : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<enum EComponentType>                   SourceComponent;                                          // 0x0070(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	TEnumAsByte<enum EComponentType>                   TargetComponent;                                          // 0x00B8(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
...
struct FAnimNode_CopyBone : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<enum EBoneControlSpace>                ControlSpace;                                             // 0x008B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_Fabrik : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<enum EBoneControlSpace>                EffectorTransformSpace;                                   // 0x0090(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bUseIKFreeze;                                             // 0x00B0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00B1(0x0003) MISSED OFFSET
	struct FVector                                     PositionFreeze;                                           // 0x00B4(0x000C) (Edit, IsPlainOldData)
	struct FVector                                     RotationFreeze;                                           // 0x00C0(0x000C) (Edit, IsPlainOldData)
	struct FVector                                     ScaleFeeze;                                               // 0x00CC(0x000C) (Edit, IsPlainOldData)
	unsigned char                                      UnknownData03[0x8];                                       // 0x00D8(0x0008) MISSED OFFSET
	struct FBoneSocketTarget                           EffectorTarget;                                           // 0x00E0(0x0060) (Edit)
	TEnumAsByte<enum EBoneRotationSource>              EffectorRotationSource;                                   // 0x0140(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x7];                                       // 0x0141(0x0007) MISSED OFFSET
	struct FBoneReference                              TipBone;                                                  // 0x0148(0x0018) (Edit)
	struct FBoneReference                              RootBone;                                                 // 0x0160(0x0018) (Edit)
	...
	bool                                               bEnableDebugDraw;                                         // 0x0180(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0xF];                                       // 0x0181(0x000F) MISSED OFFSET
};
...
struct FAnimNode_LayeredBoneBlend : public FAnimNode_Base
{
	...
	TEnumAsByte<enum ECurveBlendOption>                CurveBlendOption;                                         // 0x005D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_LookAt : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<enum EAxisOption>                      LookAtAxis;                                               // 0x00FC(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00FD(0x0003) MISSED OFFSET
	...
	TEnumAsByte<enum EAxisOption>                      LookUpAxis;                                               // 0x011D(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	...
	TEnumAsByte<enum EInterpolationBlend>              InterpolationType;                                        // 0x0140(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_ModifyBone : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<enum EBoneModificationMode>            TranslationMode;                                          // 0x0094(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EBoneModificationMode>            RotationMode;                                             // 0x0095(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EBoneModificationMode>            ScaleMode;                                                // 0x0096(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EBoneControlSpace>                TranslationSpace;                                         // 0x0097(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EBoneControlSpace>                RotationSpace;                                            // 0x0098(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EBoneControlSpace>                ScaleSpace;                                               // 0x0099(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
	TArray<struct FName>                               Names;                                                    // 0x0000(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<struct FTransform>                          Transforms;                                               // 0x000C(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
};
...
{
	struct FBonesTransfroms                            BoneTransforms;                                           // 0x0058(0x0018) (Edit, BlueprintVisible)
...
struct FAnimNode_ObserveBone : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<enum EBoneControlSpace>                DisplaySpace;                                             // 0x0070(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_PoseDriver : public FAnimNode_PoseHandler
{
	...
	TEnumAsByte<enum EBoneAxis>                        TwistAxis;                                                // 0x0100(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
...
{
	TEnumAsByte<enum ERefPoseType>                     RefPoseType;                                              // 0x002A(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x5];                                       // 0x002B(0x0005) MISSED OFFSET
};
...
struct FAnimNode_RotationMultiplier : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<enum EBoneAxis>                        RotationAxisToRefer;                                      // 0x008C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_SequenceEvaluator : public FAnimNode_AssetPlayerBase
{
	...
	TEnumAsByte<enum ESequenceEvalReinit>              ReinitializationBehavior;                                 // 0x0060(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_Trail : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<enum EAxis>                            ChainBoneAxis;                                            // 0x0074(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_TwoBoneIK : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<enum EBoneControlSpace>                EffectorLocationSpace;                                    // 0x0085(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	TEnumAsByte<enum EBoneControlSpace>                JointTargetLocationSpace;                                 // 0x0100(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
