...
#include "PUBGM_BP_Grenade_Burn_Weapon_structs.hpp"
...
public:
	...
	static UClass* StaticClass()
	{
		...
		if (!pStaticClass)
			 pStaticClass = UObject::FindClass("BlueprintGeneratedClass BP_Grenade_Burn_Weapon.BP_Grenade_Burn_Weapon_C");
		return pStaticClass;
	}
