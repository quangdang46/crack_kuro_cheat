...
#include "PUBGM_BP_Grenade_MagicDance_Weapon_structs.hpp"
...
// BlueprintGeneratedClass BP_Grenade_MagicDance_Weapon.BP_Grenade_MagicDance_Weapon_C
// 0x0018 (0x07A8 - 0x0790)
class ABP_Grenade_MagicDance_Weapon_C : public ASTExtraWeapon
{
public:
	...
	static UClass* StaticClass()
	{
		...
		if (!pStaticClass)
			 pStaticClass = UObject::FindClass("BlueprintGeneratedClass BP_Grenade_MagicDance_Weapon.BP_Grenade_MagicDance_Weapon_C");
		return pStaticClass;
	}
