...
#include "PUBGM_BP_Grenade_Burn_Weapon_classes.hpp"
...
struct ABP_Grenade_Burn_Weapon_C_GetSkillEntryForMeleeWeapon_Params
{
...
struct ABP_Grenade_Burn_Weapon_C_UserConstructionScript_Params
{
};
