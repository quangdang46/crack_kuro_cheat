...
// Function LobbyModelShowActorBP.LobbyModelShowActorBP_C.GetLobbyWeaponClass
...
void ALobbyModelShowActorBP_C::GetLobbyWeaponClass(int InWeaponAvatarID, class UClass** ObjectClass)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc = UObject::FindObject<UFunction>("Function LobbyModelShowActorBP.LobbyModelShowActorBP_C.GetLobbyWeaponClass");

	ALobbyModelShowActorBP_C_GetLobbyWeaponClass_Params params;
