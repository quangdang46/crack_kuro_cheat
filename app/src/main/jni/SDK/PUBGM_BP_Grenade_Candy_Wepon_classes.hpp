...
#include "PUBGM_BP_Grenade_Candy_Wepon_structs.hpp"
...
// BlueprintGeneratedClass BP_Grenade_Candy_Wepon.BP_Grenade_Candy_Wepon_C
// 0x0018 (0x07A8 - 0x0790)
class ABP_Grenade_Candy_Wepon_C : public ASTExtraWeapon
{
public:
	...
	static UClass* StaticClass()
	{
		...
		if (!pStaticClass)
			 pStaticClass = UObject::FindClass("BlueprintGeneratedClass BP_Grenade_Candy_Wepon.BP_Grenade_Candy_Wepon_C");
		return pStaticClass;
	}
