...
struct FUTSkillCreateData
{
	...
	TArray<class UUTSkillPhase*>                       Phases;                                                   // 0x0024(0x000C) (Edit, BlueprintVisible, ExportObject, ZeroConstructor)
	bool                                               bIgnoreDamage;                                            // 0x0030(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0031(0x0003) MISSED OFFSET
	TArray<class UUTSkillCDBase*>                      SkillCDs;                                                 // 0x0034(0x000C) (Edit, BlueprintVisible, ExportObject, ZeroConstructor)
	TMap<int, class UUTSkillWidget*>                   SkillUIs;                                                 // 0x0040(0x0050) (BlueprintVisible, ExportObject, ZeroConstructor)
	TMap<struct FString, int>                          SkillUIPathToHandle;                                      // 0x007C(0x0050) (BlueprintVisible, ZeroConstructor)
	struct FSoftClassPath                              SkillMainWidget;                                          // 0x00B8(0x0018) (Edit, BlueprintVisible)
	struct FName                                       SkillWidgetAttachPanelName;                               // 0x00D0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bInitMainSkillUI;                                         // 0x00D8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00D9(0x0003) MISSED OFFSET
	TMap<ESkillIconStatus, struct FSlateBrush>         SkillIcons;                                               // 0x00DC(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                SkillMainWidgetHandle;                                    // 0x0118(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x011C(0x0004) MISSED OFFSET
	TArray<struct FName>                               AsyncLoadingSkillUI;                                      // 0x0120(0x000C) (ZeroConstructor, Transient)
	TArray<class UUTSkillEventEffectMapForEditor*>     EditorEventEffectMap;                                     // 0x012C(0x000C) (ExportObject, ZeroConstructor, Transient)
};
...
struct FSkillActiveRepData
{
	...
	bool                                               bActive;                                                  // 0x0004(0x0001) (ZeroConstructor, IsPlainOldData)
