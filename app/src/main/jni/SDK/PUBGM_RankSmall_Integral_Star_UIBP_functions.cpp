...
#include "PUBGM_RankSmall_Integral_Star_UIBP_parameters.hpp"
...
void URankSmall_Integral_Star_UIBP_C::SetRankText(const struct FSlateColor& Color, const struct FSlateColor& ShadowColor, const struct FSlateFontInfo& FontInfo)
{
...
void URankSmall_Integral_Star_UIBP_C::SetRankIntegral(const struct FBP_STRUCT_RankIntegralLevel_type& RankIntegralLevel_Info)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
void URankSmall_Integral_Star_UIBP_C::ExecuteUbergraph_RankSmall_Integral_Star_UIBP(int EntryPoint)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
