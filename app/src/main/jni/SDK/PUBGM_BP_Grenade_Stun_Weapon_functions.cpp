...
#include "PUBGM_BP_Grenade_Stun_Weapon_parameters.hpp"
...
void ABP_Grenade_Stun_Weapon_C::UserConstructionScript()
{
	...
	if (!pFunc)
		pFunc = UObject::FindObject<UFunction>("Function BP_Grenade_Stun_Weapon.BP_Grenade_Stun_Weapon_C.UserConstructionScript");
