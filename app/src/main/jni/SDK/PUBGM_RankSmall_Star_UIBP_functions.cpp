...
#include "PUBGM_RankSmall_Star_UIBP_parameters.hpp"
...
void URankSmall_Star_UIBP_C::SetRankIntegral(const struct FBP_STRUCT_RankIntegralLevel_type& RankIntegralLevel_Info)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
