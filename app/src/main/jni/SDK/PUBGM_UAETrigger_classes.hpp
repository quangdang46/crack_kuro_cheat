...
public:
	...
	float                                              EnterAreaColdTime;                                        // 0x0598(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FTriggerAreaEvent>                   Enter_EventsList;                                         // 0x059C(0x000C) (Edit, ZeroConstructor)
	float                                              LeaveAreaColdTime;                                        // 0x05A8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FTriggerAreaEvent>                   Leave_EventsList;                                         // 0x05AC(0x000C) (Edit, ZeroConstructor)
	struct FColor                                      ShapeColor;                                               // 0x05B8(0x0004) (Edit, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x05BC(0x000C) MISSED OFFSET
	TArray<class AActor*>                              CachedEnterAreaActors;                                    // 0x05C8(0x000C) (ZeroConstructor)
