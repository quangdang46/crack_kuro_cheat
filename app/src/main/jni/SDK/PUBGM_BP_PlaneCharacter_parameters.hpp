...
#include "PUBGM_BP_PlaneCharacter_classes.hpp"
...
struct ABP_PlaneCharacter_C_AsyncChangePlaneAvatar_Params
{
...
struct ABP_PlaneCharacter_C_ChangePlaneAvatar_Params
{
	int                                                InItemID;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
