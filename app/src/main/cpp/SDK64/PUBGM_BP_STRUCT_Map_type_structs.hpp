...
struct FBP_STRUCT_Map_type
{
	...
	struct FString                                     DependPak_32_55E2C8005BC5F300264BF0060A8614DB;            // 0x0088(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     MapKey_34_7C1F1EC057F596C138AC113C09BE9DE9;               // 0x0098(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                Priority_35_377345801916E7900BD38A430E4AB949;             // 0x00A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NotNeedDownload_36_4A6306403648FF3B0E768700036E10C4;      // 0x00AC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FString                                     MapImage_37_5B95AD4015935BF959B4DDB00E841E65;             // 0x00B0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     ShowName_38_0FA0B58004CBF1EE4DD372DE09A86F25;             // 0x00C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                DebugAI_Num_39_6706ED00455805583339F7C509DDF0CD;          // 0x00D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x00D4(0x0004) MISSED OFFSET
	TArray<struct FString>                             DeathReplayConfig_as_40_2DB7C4004600B556401B450008A1FF43; // 0x00D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
};
