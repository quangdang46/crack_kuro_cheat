...
// Function GlobalUIFunctionLibrary.GlobalUIFunctionLibrary_C.ShowItemTipsWithButtonAndBias
...
// int                            PattternID                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// bool                           BP_GlobalTips_ShowLimitIcon    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// int                            BiasX                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// int                            BIasY                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UObject*                 __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UGlobalUIFunctionLibrary_C::ShowItemTipsWithButtonAndBias(int ItemId, class UWidget* Button, int ColorID, int PattternID, bool BP_GlobalTips_ShowLimitIcon, int BiasX, int BIasY, class UObject* __WorldContext)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc = UObject::FindObject<UFunction>("Function GlobalUIFunctionLibrary.GlobalUIFunctionLibrary_C.ShowItemTipsWithButtonAndBias");

	UGlobalUIFunctionLibrary_C_ShowItemTipsWithButtonAndBias_Params params;
	params.ItemId = ItemId;
	params.Button = Button;
	params.ColorID = ColorID;
	params.PattternID = PattternID;
	params.BP_GlobalTips_ShowLimitIcon = BP_GlobalTips_ShowLimitIcon;
	params.BiasX = BiasX;
	params.BIasY = BIasY;
