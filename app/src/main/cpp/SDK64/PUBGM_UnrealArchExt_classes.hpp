...
// 0x01B8 (0x03D0 - 0x0218)
class UUAEUserWidget : public UUserWidget
{
public:
	class UFrontendHUD*                                OwningFrontendHUD;                                        // 0x0218(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class ULogicManagerBase*                           OwningLogicManager;                                       // 0x0220(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UUAEWidgetContainer*                         OwningWidgetContainer;                                    // 0x0228(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	class UUAEUserWidget*                              ParentWidget;                                             // 0x0230(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData00[0xA0];                                      // 0x0238(0x00A0) MISSED OFFSET
	TArray<class UProperty*>                           Params;                                                   // 0x02D8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x10];                                      // 0x02E8(0x0010) MISSED OFFSET
	struct FScriptMulticastDelegate                    widgetSizeNofity;                                         // 0x02F8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FUserWidgetState                            DefaultUserWidgetState;                                   // 0x0308(0x0028) (Edit)
	struct FUserWidgetState                            CurrentUserWidgetState;                                   // 0x0330(0x0028) (BlueprintVisible)
	float                                              TickRate;                                                 // 0x0358(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bReceiveOnClickedEvent;                                   // 0x035C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bReceiveOnRightClickedEvent;                              // 0x035D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bReceiveOnDoubleClickedEvent;                             // 0x035E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAutoSetScreenPosOnMouseEnter;                            // 0x035F(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   ScreenPos;                                                // 0x0360(0x0008) (BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FVector2D                                   LastMouseEventScreenPos;                                  // 0x0368(0x0008) (BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0370(0x0008) MISSED OFFSET
	EUserWidgetFadingStatus                            FadingStatus;                                             // 0x0378(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0379(0x0003) MISSED OFFSET
	float                                              CurrentOpacity;                                           // 0x037C(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FadingInTime;                                             // 0x0380(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              FadingOutTime;                                            // 0x0384(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bNoFadeIn;                                                // 0x0388(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bNoFadeOut;                                               // 0x0389(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bShouldCollapse;                                          // 0x038A(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bRegistUIMsg;                                             // 0x038B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x038C(0x0004) MISSED OFFSET
	struct FString                                     UIMsgPrefix;                                              // 0x0390(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	TArray<struct FString>                             UIMsgFunctionList;                                        // 0x03A0(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	bool                                               bRegistedUIMsgToMoudle;                                   // 0x03B0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x7];                                       // 0x03B1(0x0007) MISSED OFFSET
	struct FString                                     MoudleToRegisted;                                         // 0x03B8(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
...
public:
	...
	struct FString                                     LuaFilePath;                                              // 0x0430(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	bool                                               bEnableBlueprintTick;                                     // 0x0440(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<class UUserWidget*>                         WidgetList;                                               // 0x03D0(0x0010) (ExportObject, ZeroConstructor)
