...
public:
	...
	static void ShowItemTipsWithButtonAndBias(int ItemId, class UWidget* Button, int ColorID, int PattternID, bool BP_GlobalTips_ShowLimitIcon, int BiasX, int BIasY, class UObject* __WorldContext);
