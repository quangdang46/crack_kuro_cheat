...
// bool                           Suc                            (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void ABP_PlayerLobbyPawn_C::SetAddCharacterWeaponAnimListHandle(TArray<struct FLobbyCharacterWeaponAnimData>* addAnimData, bool* Suc)
{
...
void ABP_PlayerLobbyPawn_C::OnEquipClothStateChange__DelegateSignature(class UBackpackAvatarHandle* AvatarHandle, bool IsEuqiped, int ItemId, int SlotType)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
