...
struct FUTSkillCreateData
{
	...
	TArray<class UUTSkillCDBase*>                      SkillCDs;                                                 // 0x0038(0x0010) (Edit, BlueprintVisible, ExportObject, ZeroConstructor)
	TMap<int, class UUTSkillWidget*>                   SkillUIs;                                                 // 0x0048(0x0050) (BlueprintVisible, ExportObject, ZeroConstructor)
	TMap<struct FString, int>                          SkillUIPathToHandle;                                      // 0x0098(0x0050) (BlueprintVisible, ZeroConstructor)
	struct FSoftClassPath                              SkillMainWidget;                                          // 0x00E8(0x0018) (Edit, BlueprintVisible)
	struct FName                                       SkillWidgetAttachPanelName;                               // 0x0100(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bInitMainSkillUI;                                         // 0x0108(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0109(0x0007) MISSED OFFSET
	TMap<ESkillIconStatus, struct FSlateBrush>         SkillIcons;                                               // 0x0110(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                SkillMainWidgetHandle;                                    // 0x0160(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0164(0x0004) MISSED OFFSET
	TArray<struct FName>                               AsyncLoadingSkillUI;                                      // 0x0168(0x0010) (ZeroConstructor, Transient)
	TArray<class UUTSkillEventEffectMapForEditor*>     EditorEventEffectMap;                                     // 0x0178(0x0010) (ExportObject, ZeroConstructor, Transient)
};
...
struct FUTSkillHitInfo
{
	...
	TEnumAsByte<enum EPhysicalSurface>                 HitSurfaceType;                                           // 0x0022(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FUTSkillPhaseCreateData
{
	...
	TArray<class UUTSkillCondition*>                   PhaseConditions;                                          // 0x0028(0x0010) (Edit, BlueprintVisible, ExportObject, ZeroConstructor)
	class UUTSkillPicker*                              Picker;                                                   // 0x0038(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
