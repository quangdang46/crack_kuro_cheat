...
// Function UMG.BackgroundBlur.SetEnableFromBP
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                           bEnable                        (Parm, ZeroConstructor, IsPlainOldData)

void UBackgroundBlur::SetEnableFromBP(bool bEnable)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc = UObject::FindObject<UFunction>("Function UMG.BackgroundBlur.SetEnableFromBP");

	UBackgroundBlur_SetEnableFromBP_Params params;
