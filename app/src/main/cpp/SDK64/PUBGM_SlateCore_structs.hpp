...
struct FComboButtonStyle : public FSlateWidgetStyle
{
	...
	struct FSlateBrush                                 MenuBorderBrush;                                          // 0x03F8(0x00B8) (Edit, BlueprintVisible)
	struct FMargin                                     MenuBorderPadding;                                        // 0x04B0(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
};
...
{
	struct FComboButtonStyle                           ComboButtonStyle;                                         // 0x0008(0x04C0) (Edit, BlueprintVisible)
	struct FSlateSound                                 PressedSlateSound;                                        // 0x04C8(0x0018) (Edit, BlueprintVisible)
	struct FSlateSound                                 SelectionChangeSlateSound;                                // 0x04E0(0x0018) (Edit, BlueprintVisible)
};
