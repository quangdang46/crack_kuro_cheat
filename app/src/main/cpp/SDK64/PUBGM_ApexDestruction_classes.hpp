...
{
public:
	class UDestructibleComponent*                      DestructibleComponent;                                    // 0x0398(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	unsigned char                                      bAffectNavigation : 1;                                    // 0x03A0(0x0001) (Edit, BlueprintVisible, Config)
...
public:
	...
	unsigned char                                      bFractureEffectOverride : 1;                              // 0x0898(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0899(0x0007) MISSED OFFSET
	TArray<struct FFractureEffect>                     FractureEffects;                                          // 0x08A0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, EditFixedSize, ZeroConstructor)
	bool                                               bEnableHardSleeping;                                      // 0x08B0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x08B1(0x0003) MISSED OFFSET
	float                                              LargeChunkThreshold;                                      // 0x08B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x10];                                      // 0x08B8(0x0010) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnComponentFracture;                                      // 0x08C8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData04[0x98];                                      // 0x08D8(0x0098) MISSED OFFSET
...
{
public:
	struct FDestructibleParameters                     DefaultDestructibleParameters;                            // 0x0348(0x0088) (Edit)
	TArray<struct FFractureEffect>                     FractureEffects;                                          // 0x03D0(0x0010) (Edit, EditFixedSize, ZeroConstructor)
