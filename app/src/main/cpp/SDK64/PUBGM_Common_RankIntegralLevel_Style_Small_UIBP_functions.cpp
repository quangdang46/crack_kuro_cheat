...
void UCommon_RankIntegralLevel_Style_Small_UIBP_C::SetRankCustomColor(int rankIntegral, class UTextBlock* textIntegralName, const struct FSlateColor& Color)
{
...
void UCommon_RankIntegralLevel_Style_Small_UIBP_C::SetRankInteralCommon(int rankIntegral, class UTextBlock* textIntegralName)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
