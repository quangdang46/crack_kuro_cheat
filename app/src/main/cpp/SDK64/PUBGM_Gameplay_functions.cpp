...
// Function Gameplay.UAELevelSequenceActor.OnRep_ServerStartPlayTime
// (Final, Native, Protected)

void AUAELevelSequenceActor::OnRep_ServerStartPlayTime()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc = UObject::FindObject<UFunction>("Function Gameplay.UAELevelSequenceActor.OnRep_ServerStartPlayTime");

	AUAELevelSequenceActor_OnRep_ServerStartPlayTime_Params params;
