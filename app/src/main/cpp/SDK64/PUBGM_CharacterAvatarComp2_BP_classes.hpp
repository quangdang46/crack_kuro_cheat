...
public:
	...
	class UBackpackAvatarItemColor*                    BasedAvatarColorHandle;                                   // 0x0F18(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UBackpackAvatarItemPattern*                  BasedAvatarPatternHandle;                                 // 0x0F20(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<int>                                        HoodClothSubTypeMap;                                      // 0x0F28(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	EBattleItemUseReason                               PreEquipClothReason;                                      // 0x0F38(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0F39(0x0007) MISSED OFFSET
	unsigned char                                      UnknownData01[0x28];                                      // 0x0F39(0x0028) UNKNOWN PROPERTY: SoftObjectProperty CharacterAvatarComp2_BP.CharacterAvatarComp2_BP_C.MaleBatchBodySoftPath
	unsigned char                                      UnknownData02[0x28];                                      // 0x0F68(0x0028) UNKNOWN PROPERTY: SoftObjectProperty CharacterAvatarComp2_BP.CharacterAvatarComp2_BP_C.FemaleBatchBodySoftPath
	bool                                               bForbidBindAvatarEquippedEvent;                           // 0x0F90(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x0F91(0x0007) MISSED OFFSET
	TArray<int>                                        NeedModifyVehicleID;                                      // 0x0F98(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
