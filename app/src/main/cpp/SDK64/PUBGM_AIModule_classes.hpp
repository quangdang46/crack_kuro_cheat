...
public:
	...
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x0438(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;               // 0x0438(0x0001) (Edit, BlueprintVisible)
	...
	class UBrainComponent*                             BrainComponent;                                           // 0x0448(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	class UPawnActionsComponent*                       ActionsComp;                                              // 0x0458(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlackboardComponent*                        Blackboard;                                               // 0x0460(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	class UClass*                                      DefaultNavigationFilterClass;                             // 0x0470(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData02[0x1];                                       // 0x0488(0x0001) MISSED OFFSET
	bool                                               UseGameplayTasksComponent;                                // 0x0489(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShareNavigationSystem;                                   // 0x048A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x048B(0x0001) MISSED OFFSET
	struct FVector                                     ShareNavSysOffset;                                        // 0x048C(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0x30];                                      // 0x0700(0x0030) MISSED OFFSET
...
public:
	...
	unsigned char                                      bDrawLabels : 1;                                          // 0x0809(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x0809(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x0809(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x0809(0x0001) (Edit)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x0809(0x0001) (Edit)
	TEnumAsByte<enum EEnvQueryRunMode>                 QueryingMode;                                             // 0x080A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x25];                                      // 0x080B(0x0025) MISSED OFFSET
