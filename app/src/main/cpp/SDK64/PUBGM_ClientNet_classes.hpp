...
public:
	...
	class UGCloudSDK*                                  _GCloudSDKInst;                                           // 0x0240(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    StartTickNetPackageDelegate;                              // 0x0248(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x118];                                     // 0x0258(0x0118) MISSED OFFSET
...
public:
	...
	bool                                               OpenBuglyLogReport;                                       // 0x0118(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0119(0x0003) MISSED OFFSET
	int                                                MaxBufferSize;                                            // 0x011C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
