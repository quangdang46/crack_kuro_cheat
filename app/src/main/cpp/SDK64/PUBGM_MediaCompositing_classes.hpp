...
{
public:
	class UMediaPlaneComponent*                        MediaPlane;                                               // 0x0398(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0xC0];                                      // 0x0700(0x00C0) MISSED OFFSET
